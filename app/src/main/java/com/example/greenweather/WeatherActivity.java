...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceSatate){
        ...
        if(weatherString != null){
            //有缓存时直接解析天气数据
            Weather weather = Utility.handleWeatherRespose(weatherString);
    ...
    public void requestWeather(final String weatherId){
        String wertherUrl = "http://guolin.tech/api/weather?cityid="+
        ...
        HttpUtil.sendOkHttpRequest(wertherUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                final Weather weather = Utility.handleWeatherRespose(responseText);
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
